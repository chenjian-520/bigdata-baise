package com.ict.bigdata.spark.job;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ict.bigdata.spark.job.common.PermissionManager;
...
public class SparkApp implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            permissionManager = (PermissionManager) Class.forName("com.ict.bigdata.spark.job.common.ProdPermissionManager").newInstance();
